...
const callingCodes: Record<string, string> = {
  ...
  BL: '+590', BM: '+1', BN: '+673', BO: '+591', BQ: '+599', BR: '+55', BS: '+1', BT: '+975', BV: '+47',
  BW: '+267', BY: '+375', BZ: '+501',
  ...
  SX: '+1', SY: '+963', SZ: '+268',
  TC: '+1', TD: '+235', TF: '+262', TG: '+228', TH: '+66', TJ: '+992', TK: '+690', TL: '+670', TM: '+993',
  TN: '+216', TO: '+676', TR: '+90', TT: '+1', TV: '+688', TW: '+886', TZ: '+255',
...
const pinnedRegions = ['CN', 'US', 'GB', 'JP', 'KR', 'SG', 'AU', 'CA', 'FR', 'DE']

export const countryRegions: CountryRegion[] = Object.entries(callingCodes)
  .map(([code, dialCode]) => ({
    code,
    dialCode,
    label: zhNames.of(code) || code,
    englishLabel: enNames.of(code) || code,
  }))
  .sort((left, right) => {
    const leftPinned = pinnedRegions.indexOf(left.code)
    const rightPinned = pinnedRegions.indexOf(right.code)
...
export function getCountryRegion(code: string) {
  return countryRegions.find(region => region.code === code) || countryRegions.find(region => region.code === 'US')!
}
